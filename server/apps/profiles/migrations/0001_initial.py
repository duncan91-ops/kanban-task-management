        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "small",
                    models.URLField(
                        max_length=500, verbose_name="Small sized Profile Photo URL"
                    ),
                ),
                (
                    "medium",
                    models.URLField(
                        max_length=500, verbose_name="medium sized Profile Photo URL"
                    ),
                ),
                (
                    "large",
                    models.URLField(
                        max_length=500, verbose_name="large sized Profile Photo URL"
                    ),
                ),
                (
                    "profile",
